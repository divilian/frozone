...
def singleWithResponseAndProdding_csv_to_jsonl(csv_files: Union[str, List[str]],output_path: str,system_instructions: str = "INSTRUCTIONS"):
...
One of "base, single, singleWithResponse, or singleWithResponseAndProdding" which refer to the diffrent versions of the converter that we have created. Generally, it is best to default to singleWithResponse.
        ...
        if len(args) != 5:
            ...
            if args[4] == "base":
              ...
              singleWithResponseAndProdding_csv_to_jsonl(inputs, output_path = output, system_instructions=system_instructions)
            else:
