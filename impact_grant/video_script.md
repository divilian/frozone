...
with Bethanie Hackett, Laur Rider, and Garrett McKenzie, three amazing computer
science students who're working with me on a research project we call **Project
Frozone**. (If you've seen _The Incredibles_, you may remember Frozone as the
superhero who can shoot ice out of his hands, kind of like Elsa in Frozen.)
...
participants engage in a chat room experiment with Frobot and two other bots
which are designed simply to mimic mainstream social media content. We'll
analyze the chat logs from this experiment, as well as surveys that
participants complete in which they comment on what they thought about Frobot's
contributions to the discussion. In the other, we'll simulate a social media
platform at a larger scale, using a technique called Agent-Based Modeling. This
...
suite of language modeling tools to fine-tune the Frobot on large quantities of
social media text. This will also require a considerable amount of cloud-based
storage. Additionally, we'll be using the Google Cloud infrastructure both to
host our chatroom experiment and also to carry out computationally-intensive
simulations on the agent-based model. The computing and storage resources
...
strengthening trust are among the most important things we can do for our
society right now, and we hope that project Frozone can contribute to upholding
the values we all hold dear. Thanks for your time!
